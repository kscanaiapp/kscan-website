...
export const metadata: Metadata = {
  ...
  description: "Learn how K Scan AI protects accounts, images, AI interactions, and app activity through secure development, automated security checks, release controls, access controls, monitoring, and responsible vulnerability response.",
