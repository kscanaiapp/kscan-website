...
// source document: public/docs/kscan-terms-and-conditions.docx
// Effective Date: May 13, 2026 | Last Updated: July 18, 2026
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `The current Android version is distributed as an open-test or beta release. Beta features may contain errors, interruptions, incomplete functionality, provider limits, or changes. These Terms apply to the beta Service as well as later generally available versions unless replaced by updated terms.`,
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `The Service allows users to capture or select clothing-focused images. The current Android open-test release may allow selection of one to five images in a scan flow, review and removal before submission, and identification of multiple garments across those images.`,
        },
        {
          type: "paragraph",
      ...
      blocks: [
        {
          ...
          rows: [
            ["Android release posture", "Open-test beta; package com.kscanai.app"],
