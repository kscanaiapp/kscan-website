...
// source document: public/docs/kscan-privacy-policy.docx
// Effective Date: June 12, 2026 | Last Updated: July 18, 2026
  ...
  sections: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            `The Android open-test release can process up to five selected images in one scan flow and may identify multiple garments across those images.`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `The current Android open-test application uses package com.kscanai.app. Platform Data Safety disclosures and in-app disclosures should be read together with this Policy. If a feature materially changes data collection or processing, K Scan will update this Policy and any required platform disclosures before or when the change is enabled.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `When you intentionally start a scan or select images, K Scan may access the camera or the images you select through the operating-system image picker. The current Android open-test release supports selecting and reviewing between one and five images before submission. You can remove selected images before starting analysis.`,
        },
        {
          type: "paragraph",
