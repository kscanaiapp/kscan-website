  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `This Policy applies to the K Scan AI website, Android app, beta and open-test releases, APIs, AI systems, and related services unless a separate privacy notice applies. It covers information you provide, information generated through use of the Service, information stored locally on your device, information stored in K Scan AI cloud systems, and information processed by authorized service providers.`,
        },
        {
          type: "paragraph",
          text: `The current Android open-test application uses package com.kscanai.app. Platform Data Safety disclosures and in-app disclosures should be read together with this Policy. If a feature materially changes data collection or processing, K Scan AI will update this Policy and any required platform disclosures before or when the change is enabled.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `Deletion requests are generally processed within 30 days after verification, subject to legal, security, fraud-prevention, dispute-resolution, backup, and technical limitations. K Scan AI does not claim that deletion is immediate or fully automated across every system.`,
        },
        {
          type: "paragraph",
