  ...
  sections: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            `K Scan is not designed for surveillance, facial recognition, biometric identification, or identifying people. K Scan does not create or retain biometric templates, faceprints, face geometry, or identity profiles.`,
            ...
            `Images, prompts, style context, and related information may be processed through K Scan cloud systems and authorized AI providers. The current release is not device-only or cloud-free.`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `K Scan does not knowingly collect personal information from children or minors. If we learn that we collected information from a person under 18, we will take reasonable steps to delete or restrict it, subject to legal, safety, security, fraud-prevention, backup, and technical requirements. K Scan does not participate in Google Play Families or Designed for Families for the current release posture.`,
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "definition",
          term: "Elise:",
          text: `K Scan's AI stylist interface. StyleChat is Elise's conversational capability. Elise may provide text responses and, when enabled and available, generated spoken responses.`,
        },
        {
          type: "definition",
          term: "Recent Scans:",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `When you intentionally start a scan or select images, K Scan may access the camera or the images you select through the operating-system image picker. The current Android release supports selecting and reviewing between one and five images before submission. You can remove selected images before starting analysis.`,
        },
        {
          type: "paragraph",
          text: `Submitted Visual Data may be resized, compressed, transmitted through encrypted connections, and processed by K Scan cloud services and authorized AI providers. A scan may produce one result, multiple garment results, partial results, or no result. K Scan may maintain an association between each detected item and its source image so that results, saved items, shopping options, and Dressing Room actions remain understandable.`,
        },
        {
          type: "paragraph",
          text: `Camera access is activated only when you initiate a camera action. K Scan does not use the camera for continuous monitoring, background capture, or surveillance.`,
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: `When you use Mirror Selfie, K Scan may process the image and pose/body-positioning information needed to provide the requested fashion experience. K Scan does not use Mirror Selfie to identify you, perform facial recognition, authenticate identity, or create biometric identity profiles.`,
        },
        { type: "subheading", text: "4.3 Device-Local Recent Scans and Commerce Snapshots" },
        {
          type: "paragraph",
          text: `Recent Scans are stored on the device by default. When you save a scan that contains shopping options, K Scan may store a snapshot of the available retailer, source, price, currency, product link, availability, product type, and product image information. Reopening a saved scan uses that stored snapshot. If no shopping option existed when the scan was saved, none may appear when it is reopened.`,
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: `When you save or upload content to account-backed features, K Scan may store the content and related metadata in private cloud storage associated with your account. This may include selected images, item metadata, style preferences, timestamps, and references needed to display, organize, retrieve, or delete the content. Signed or time-limited URLs may be generated to display protected images.`,
        },
        { type: "subheading", text: "4.5 Elise, StyleChat, Signature Style, and Spoken Responses" },
        {
          type: "paragraph",
          text: `When you use Elise or her StyleChat conversational capability, K Scan may process your prompts, messages, selected item or image context, recent conversation context, saved style preferences, and Signature Style signals needed to respond. Signature Style may include fashion preferences inferred from items you save, scan, like, reject, discuss, or organize.`,
        },
        {
          type: "paragraph",
          text: `When Spoken Responses are enabled, K Scan may send the text of an eligible Elise response, limited message and session identifiers, and the selected stylist voice profile to K Scan's speech service and an authorized text-to-speech provider, currently ElevenLabs, to generate audio and timing information. Generated audio may be cached temporarily on the device for playback and removed after playback, interruption, or cache cleanup.`,
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: `Owned Dressing Rooms, room items, and Shared with Me memberships are account-backed. K Scan may process room names, descriptions, item snapshots, images, participants, membership status, messages, reactions, timestamps, invitations, removals, revocations, and related metadata to operate these features.`,
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: `K Scan processes block relationships and moderation reports to enforce user-safety boundaries. A blocked or departed participant may lose collaboration rights, and unblocking does not necessarily restore a prior collaboration without a fresh valid share or invitation.`,
        },
        {
          type: "paragraph",
          text: `Users may report Dressing Room users or messages in-app. K Scan may store the reporter, target user/content identifiers, room/message identifiers, report category, timestamps, status, and limited moderation context as necessary to investigate and enforce safety and policy requirements.`,
        },
        { type: "subheading", text: "4.7 Shopping, Retailer, Marketplace, and Product Interaction Data" },
        {
          type: "paragraph",
          text: `K Scan may process scan-derived product signals, search terms, item attributes, product identifiers, retailer or marketplace identifiers, product URLs, product images, saved items, and outbound-link interactions to return shopping options and retailer-neutral product results. Product availability, pricing, images, currency, and links may change or be incomplete.`,
        },
        {
          type: "paragraph",
          text: `When you open a third-party retailer or marketplace link, you leave K Scan and the third party's privacy policy applies. K Scan does not intentionally provide raw uploaded images to retailers for their independent use unless separately disclosed. K Scan may receive referral or affiliate compensation from qualifying outbound links, but the current mobile release does not use third-party advertising SDKs or Advertising ID for targeted advertising.`,
        },
        ...
        {
          type: "paragraph",
          text: `Approximate location may also be inferred from an IP address for security, localization, fraud prevention, or service delivery. K Scan does not use location for continuous tracking.`,
        },
        ...
        {
          type: "paragraph",
          text: `When you use the K Scan website, we may process browser, device, referral, traffic, cookie, and interaction data to operate the website, maintain security, measure performance, and understand usage. Where required by law, non-essential cookies or similar technologies are used only after valid consent.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: `Users can report AI-generated responses from within K Scan without leaving the app. AI-response reports use structured reasons and limited allowlisted identifiers/context tied to the authenticated reporter. The report record does not store the raw AI response, uploaded photos, scan media, or raw image content.`,
        },
        {
          type: "paragraph",
          text: `K Scan does not use AI to identify people, perform facial recognition, create biometric profiles, infer protected traits for legally significant decisions, or make decisions about employment, housing, credit, health care, insurance, or similar opportunities.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `K Scan may disclose information to service providers and other recipients only as reasonably necessary for the purposes described in this Policy, based on the feature used, user choices, app version, provider configuration, and legal requirements.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `K Scan may use first-party operational logs and basic usage information to maintain security, understand feature performance, diagnose errors, and improve the Service. The current mobile release does not use third-party advertising SDKs, does not collect Advertising ID for targeted advertising, and does not track users across third-party apps or websites for targeted advertising.`,
        },
        {
          type: "paragraph",
          text: `If K Scan later introduces cross-app tracking, targeted advertising, advertising SDKs, or activities requiring consent or App Tracking Transparency, K Scan will update this Policy and platform disclosures and request required consent before enabling those activities.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `K Scan does not sell raw scans, uploaded images, Elise messages, biometric identifiers, face templates, voiceprints, precise location, government identification, payment-card information, or sensitive personal information for independent third-party use.`,
        },
        {
          type: "paragraph",
          text: `K Scan may use aggregated or de-identified information for internal analytics, security, service improvement, product planning, trend analysis, and business reporting, provided the information does not reasonably identify a person. If K Scan later begins a regulated sale or sharing activity, it will provide required notice, consent, and opt-out controls before or when the activity begins.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `K Scan retains information only as long as reasonably necessary for the purposes described in this Policy, unless a longer period is required or permitted by law.`,
        },
        {
          type: "bullets",
          items: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `You may request deletion through the app at Settings > Account > Delete Account, through the public deletion page, or by contacting K Scan. The external deletion resource is available at https://kscan.app/legal/delete-account.`,
        },
        {
          type: "paragraph",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `Residents of California and other U.S. states with applicable privacy laws may have rights to know, access, correct, delete, obtain a copy of, or opt out of certain processing of personal information, and to avoid unlawful discrimination for exercising those rights, subject to legal exceptions. K Scan honors Global Privacy Control signals where required by law.`,
        },
        {
          type: "paragraph",
          text: `The current mobile release does not use third-party advertising SDKs or Advertising ID for targeted advertising. K Scan does not sell raw scans, uploaded images, biometric data, or sensitive personal information. Requests may be submitted through available in-app controls, https://kscan.app/legal/delete-account, or kscanai.app@gmail.com.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `Information may be processed in the United States and other countries. Where required, K Scan uses lawful transfer mechanisms and safeguards, which may include Standard Contractual Clauses or other approved mechanisms.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `K Scan implements reasonable administrative, technical, and organizational safeguards designed to protect information, including encryption in transit where appropriate, access controls, private storage where appropriate, actor-scoped authorization, data minimization, and operational security practices. No system can be guaranteed completely secure, and K Scan does not use absolute-security or zero-knowledge claims for the current mobile architecture.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `The Service is intended for adults 18 and older and is not directed to children or minors. If you believe a minor has provided information to K Scan, contact kscanai.app@gmail.com.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `In the current release, shopping actions route users to third-party pages for physical goods. K Scan does not process payment-card information for those purchases. If K Scan later offers paid digital features or subscriptions in the app, it will use Google Play Billing, Apple In-App Purchase, or other required payment methods and will update applicable disclosures.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: `K Scan may update this Privacy Policy as the Service, data flows, providers, platform requirements, or law changes. For material changes, K Scan will provide additional notice or obtain consent where required. The Last Updated date will be revised when changes are published.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            ["Financial information", "Payment-card data for retailer purchases", "Not collected by K Scan in the current third-party checkout flow",],
